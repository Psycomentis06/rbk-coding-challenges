...
<nav class="navbar px-4">
  ...
  <div class="navbar-center">
    <Link to="/edit/links">
      <button class="{pathname === '/edit/links' ? 'bg-base-300' : ''} btn btn-ghost focus:bg-base-300 normal-case text-primary mx-2 px-8">
    ...
    <Link to="/edit">
      <button class="{pathname === '/edit' ? 'bg-base-300' : ''} btn btn-ghost focus:bg-base-300 normal-case text-primary mx-2 px-8">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
